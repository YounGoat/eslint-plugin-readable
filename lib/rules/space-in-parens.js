/**
 * Restrict the whitespaces inside parentheses.
				...
				if (token.type !== 'Punctuator') {
					...
					if (whitespace != '' && whitespace != ' ') {
						context.report({
							node,
							loc: token.loc.start,
							message: 'unexpected whitespace inside this paren'
						});
						break;
					}
...
module.exports = {
	meta: {
		docs: {
			description: 'require matching spaces inside parenthese couple',
			category: 'Readable',
			recommended: true
		},
		fixable: null,
